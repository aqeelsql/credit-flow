...
class Settings(BaseSettings):
    ...
    serpapi_api_key: str = Field(default="", repr=False, validation_alias=AliasChoices("SCRAPER_SERPAPI_API_KEY", "SERPAPI_API_KEY"))
    serpapi_search_endpoint: str = Field(default="https://serpapi.com/search.json", validation_alias=AliasChoices("SCRAPER_SERPAPI_SEARCH_ENDPOINT", "SERPAPI_SEARCH_ENDPOINT"))
    serpapi_engine: str = Field(default="google", validation_alias=AliasChoices("SCRAPER_SERPAPI_ENGINE", "SERPAPI_ENGINE"))
    serpapi_gl: str = Field(default="us", validation_alias=AliasChoices("SCRAPER_SERPAPI_GL", "SERPAPI_GL"))
    serpapi_hl: str = Field(default="en", validation_alias=AliasChoices("SCRAPER_SERPAPI_HL", "SERPAPI_HL"))
    serpapi_google_domain: str = Field(default="google.com", validation_alias=AliasChoices("SCRAPER_SERPAPI_GOOGLE_DOMAIN", "SERPAPI_GOOGLE_DOMAIN"))
    serpapi_tbm: str = Field(default="", validation_alias=AliasChoices("SCRAPER_SERPAPI_TBM", "SERPAPI_TBM"))
