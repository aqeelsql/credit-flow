...
class EventPublisher:
    ...
    async def publish(self, routing_key: str, payload: dict) -> None:
        try:
            ...
            raise GatewayError("event_bus_unavailable", "RabbitMQ event bus is unavailable.", 503) from exc
        if self._exchange is None:
            raise GatewayError("event_bus_unavailable", "RabbitMQ event bus is unavailable.", 503)
